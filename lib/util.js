var util = {
    ...
    checkSendMessageInfo: function(msginfo) {
        if (!util.isObject(msginfo)) {
            return {
    ...
    checkUnbindInfo: function (msginfo) {
        if (!util.isObject(msginfo)) {
            return {
                msg: 'msgInfo must be Object.',
                pass: false
        ...
        if (msginfo.card_no || msginfo.bind_id) {
            return {
                msg: 'ok',
                pass: true
            }
            ...
            return {
                msg: 'msgInfo must be have key card_no or bind_id',
                pass: false
            }
        }
    },
    ...
    getSendMessageKey: function() {
        return ['bank_phone', 'amount', 'idcard', 'acct_name', 'card_no']
    }
}
module.exports = util;